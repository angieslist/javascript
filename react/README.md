...
## Quotes
  ...
  - Always use single quotes (`'`) for JSX attributes: [`jsx-quotes`](http://eslint.org/docs/rules/jsx-quotes)

  > Why? JSX is just syntax around javascript. Don't get confused that this is HTML or something else
